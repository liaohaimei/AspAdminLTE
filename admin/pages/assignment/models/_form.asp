...
<input type="hidden" id="updateid" value="<%=Easp.Var("id")%>">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 <%=Easp.Var("typ")%>">
                    <label>
                      <input type="radio" name="editpwd" class="flat-red" value="0" data-v="" checked> 不修改
                    </label>
                    <label>
                      <input type="radio" name="editpwd" class="flat-red" value="1" data-v="pass"> 修改
                    </label>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10 <%=Easp.Var("typ")%>">
                    <input type="password" autocomplete="off"  class="form-control"  id="input-password" name="password" value="" placeholder="密码">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <label>
                      <input type="radio" name="status" class="flat-red" value="1" data-v="" checked> 启用
                    </label>
                    <label>
                      <input type="radio" name="status" class="flat-red" value="0" data-v="pass"> 禁用
                    </label>
                  </div>
                </div>
              ...
              <div class="box-footer">
                <button type="submit" class="col-sm-offset-2 btn btn-info"><%=Easp.Var("btnName")%></button>
              </div>
              <!-- /.box-footer -->
          </form>
