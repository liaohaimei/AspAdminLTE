...
'## easp.ipinfo.asp
'## -------------------------------------------------------------------
'## Feature     :   EasyAsp IpInfo Class
'## Version     :   v1.1 Alpha
'## Author      :   Easp.智者(Liaoyizhi[at]gmail.com)
'## Update Date :   2010/03/23 15:35
'## Description :   EasyAsp IP信息查询类（插件）
'##					本类修改自互联网流传代码
...
'##	
'## Examples	:	Easp.W Easp.Ext("ipinfo").GetIpInfo("192.168.1.1","cl")	'直接使用
'##					With Easp.Ext("ipinfo")
'##						.SetQQWryFile = "/Data/QQWry.Dat"		'设置QQWry.Dat文件路径
'##						Easp.WN .GetWryInfo()(1)				'输出数据库IP地址数目
'##						Easp.WN .GetIpInfo(Easp.GetIp(),5)		'输出当前访问者IP信息
'##					End With
'######################################################################

Class EasyAsp_IpInfo
	' ============================================
	' 变量声明
	' ============================================
	...
	Private Sub Class_Initialize
		...
		Easp.Error(20001) = "您的服务器不支持 Adodb.Stream 组件."
	End Sub
	' ============================================
	' 类终结
	' ============================================
	...
	Public Function QQWry(ByVal DotIP)
		If Not Easp.IsInstall("Adodb.Stream") Then Easp.Error.Raise 20001
		Dim IP, nRet
